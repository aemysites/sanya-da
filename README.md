...
## Environments
- Preview: https://main--sanya-da--aemysites.aem.page/
- Live: https://main--sanya-da--aemysites.aem.live/
- Block Library: https://main--sanya-da--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `sanya-da` directory in your favorite IDE and start coding :)
